...
while(limit<=55)                        // max. we will definitely get a 10 at the 55th dice roll in worst case
{
...
console.log("Least no. of times - "+KeyLeast);
console.log("Most no. of times - "+mostNum);